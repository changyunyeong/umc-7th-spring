...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -323301788L;
    ...
    public final umc7th.example.umc7th.domain.QMission mission;

    public final EnumPath<umc7th.example.umc7th.domain.enums.MissionStatus> status = createEnum("status", umc7th.example.umc7th.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc7th.example.umc7th.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
